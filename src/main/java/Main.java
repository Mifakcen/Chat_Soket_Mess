...
public class Main {
    ...
    //Для проверки дабавляем и комитим трех пользователей
    ...
    //Очищаем базу при этом интрементный счетчик несбрасивается
    public static void deleteAllEx() throws SQLException {
        stmt.executeUpdate("DELETE FROM students");
    }

    //Удаляем тех кто соответствует условию
    ...
    public static void connect() throws ClassNotFoundException, SQLException {
        ...
        connection = DriverManager.getConnection("jdbc:sqlite:C:/Users/Mifa/Documents/java_socket_chat/chat.db");
